#ifndef __REAR_LIDAR_ROI_HPP__
#define __REAR_LIDAR_ROI_HPP__
#pragma once
...
class RearLidarRoi{
public:
    RearLidarRoi(ros::NodeHandle &nh_);
    ~RearLidarRoi();
...
private:
    ...
    float ego_vehicle_x = 2.7;                                  // in rear lidar frame
    float ego_vehicle_y = 0.0;                                  // in rear lidar frame


};

#endif // __REAR_LIDAR_ROI_HPP__